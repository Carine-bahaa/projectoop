...
public abstract class User
{
    ...
    public static boolean login (String username, String password) {
        ...
        for (int i =0; i < size; i++) {
           if (data.Patients.get(i).getUsername().equals(username) && data.Patients.get(i).getPassword().equals(password)
                   || data.Doctors.get(i).getUsername().equals(username) && data.Doctors.get(i).getPassword().equals(password)
                   || data.Receptionists.get(i).getUsername().equals(username) && data.Receptionists.get(i).getPassword().equals(password)) {
               return true;
           } else {
               return false;
           }
