...
public class Doctor extends User {
    ...
    private ArrayList<int[]> availableHours; // List of start-end pairs
    ...
    public Doctor (String username, String password, String firstName, String lastName, String email,
                   String mobileNum,String[] availableDays,ArrayList<int[]> availableHours,String specialization)
    {
    ...
    public ArrayList<int[]> getAvailableHours() {
