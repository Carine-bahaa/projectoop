            ...
            do {
                ...
                "1)Enter Username and password Again\n" + "2)Sign Up\n");
                    ...
                    if( choice == 1)
                    {
                        ...
                        ArrayList<int[]> d_availableHours = new ArrayList<>();
                        for (int i =0 ;i < 3 ;i++) {
                            System.out.println("Enter Day");
                            d_availableDays[i] = input.next();
                            System.out.println("Enter available time (Start End, in hours, e.g., 9 17):");
                            int start = input.nextInt(); // Get start time
                            int end = input.nextInt();   // Get end time

                            d_availableHours.add(new int[]{start, end});
                        }
            ...
            do{
                ...
                switch (action)
                {
                    ...
                    case 2:
                        ...
                        for (Doctor doctor : data.Doctors) {
                            if (doctor.getFirstName().equals(doctorData) || doctor.getMobileNumber().equals(doctorData)) {
                                ...
                                appointment.BookAppointment(requestedDay, requestedTimeSlot, doctor, patientName);
                        ...
                        if (!doctorFound) {
                            System.out.println("Doctor not found. Please check the details and try again.");
                        }
                        break;
                    ...
                    case 3:
                        ...
                        AppointmentReservation CancelAppointment = new AppointmentReservation();
                        CancelAppointment .CancelAppointment(cancelPatientName);
                ...
                switch (action) {
                    case 1:
                        ...
                        else if(update==2)
                        {
                            ...
                            Receptionist.changeEmail(currentMobilenum ,newMobileNum );
                        }
